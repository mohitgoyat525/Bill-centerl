...
const CustomButton = (props) => {
  return (
    <>
      <button className={` ${props.customClass} rounded-b-full font-helvetica py-4 max-sm:py-2 px-[22px] border border-solid rounded-e-full text-base font-semibold text-white  bg-skyBlue
