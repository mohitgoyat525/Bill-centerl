  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: `url(${HeroSecBgImg})` }}
      >
          ...
          <div className="flex items-center max-lg:flex-col max-xl:gap-8 max-lg:gap-6 max-xl:pt-10 max-md:pt-7">
            <div className="w-6/12 max-lg:w-full">
              <div>
                ...
                <p className="font-helvetica max-lg:text-center text-base font-normal max-w-[506px] pt-4 text-white max-lg:max-w-none">
            ...
            <div className="w-6/12 max-lg:w-full max-lg:mt-6">
              <img
                src={HeroSecGirkImg}
                alt="work"
                className="pointer-events-none w-full max-w-[558px] max-lg:mx-auto relative z-0 translate-y-[120px] max-xl:translate-y-0"
              />
            </div>
          </div>
        </div>
